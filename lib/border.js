...
function getMountainWallOuter(neighbours) {
  ...
  if (
    neighbours.N === mountains.MOUNTAIN_TILE_ID &&
    neighbours.W === mountains.MOUNTAIN_TILE_ID &&
    neighbours.SE === mountains.MOUNTAIN_TILE_ID
  ) {
    return mountains.MOUNTAIN_WALL_INNER_NW_SE
  }

  if (
    neighbours.S === mountains.MOUNTAIN_TILE_ID &&
    neighbours.W === mountains.MOUNTAIN_TILE_ID &&
    neighbours.E === mountains.MOUNTAIN_TILE_ID
  ) {
    return mountains.MOUNTAIN_WALL_INNER_SW_E
  }
  ...
  if (
    ...
    return mountains.MOUNTAIN_WALL_INNER_W_SE
  }
  ...
  if (
    ...
    if (Math.random() < 0.5) {
      return mountains.MOUNTAIN_WALL_INNER_NE
    } else {
      return mountains.MOUNTAIN_WALL_N
    }
  }
  ...
  if (
    ...
    return mountains.MOUNTAIN_WALL_INNER_S_N
  }
  ...
  if (
    ...
    return mountains.MOUNTAIN_WALL_INNER_E_W
  }
  ...
  if (
    ...
    return mountains.MOUNTAIN_WALL_INNER_NW
  }
  ...
  if (
    ...
    if (Math.random() < 0.5) {
      return mountains.MOUNTAIN_WALL_INNER_SW
    } else {
      return mountains.MOUNTAIN_WALL_W
    }
  }

  if (neighbours.W === mountains.MOUNTAIN_TILE_ID && Math.random() < 0.5) {
    return mountains.MOUNTAIN_WALL_E
  }

  if (neighbours.N === mountains.MOUNTAIN_TILE_ID && Math.random() < 0.5) {
    return mountains.MOUNTAIN_WALL_S
  }

  if (neighbours.S === mountains.MOUNTAIN_TILE_ID) {
    return mountains.MOUNTAIN_WALL_N
  }

  if (neighbours.E === mountains.MOUNTAIN_TILE_ID) {
    return mountains.MOUNTAIN_WALL_W
  }

  if (neighbours.SE === mountains.MOUNTAIN_TILE_ID) {
    return mountains.MOUNTAIN_WALL_SE
  }

  if (
    neighbours.SW === mountains.MOUNTAIN_TILE_ID &&
    neighbours.W !== mountains.MOUNTAIN_TILE_ID &&
    neighbours.S !== mountains.MOUNTAIN_TILE_ID
  ) {
    if (Math.random() < 0.33) {
      return mountains.MOUNTAIN_WALL_NE
    }
  }
...
function getFloatingBorder(neighbours) {
  ...
  if (neighbours.W === 0 && neighbours.N === 0) {
    borders.push(mountains.MOUNTAIN_BORDER_NW)
  }

  if (neighbours.W === 0 && neighbours.S === 0) {
    borders.push(mountains.MOUNTAIN_BORDER_SW)
  }

  if (neighbours.E === 0 && neighbours.S === 0) {
    borders.push(mountains.MOUNTAIN_BORDER_SE)
  }

  if (neighbours.E === 0 && neighbours.N === 0) {
    borders.push(mountains.MOUNTAIN_BORDER_NE)
  }

  if (neighbours.E === 0 && neighbours.S !== 0 && neighbours.N !== 0) {
    borders.push(mountains.MOUNTAIN_BORDER_EAST)
  }
  if (neighbours.N === 0 && neighbours.E !== 0 && neighbours.W !== 0) {
    borders.push(mountains.MOUNTAIN_BORDER_NORTH)
  }
  if (neighbours.S === 0 && neighbours.E !== 0 && neighbours.W !== 0) {
    borders.push(mountains.MOUNTAIN_BORDER_SOUTH)
  }
  if (neighbours.W === 0 && neighbours.S !== 0 && neighbours.N !== 0) {
    borders.push(mountains.MOUNTAIN_BORDER_WEST)
  }

  if (neighbours.NW === 0 && neighbours.N !== 0 && neighbours.W !== 0) {
    borders.push(mountains.MOUNTAIN_BORDER_INNER_NW)
  }
  if (neighbours.NE === 0 && neighbours.E !== 0 && neighbours.N !== 0) {
    borders.push(mountains.MOUNTAIN_BORDER_INNER_NE)
  }
  if (neighbours.SE === 0 && neighbours.E !== 0 && neighbours.S !== 0) {
    borders.push(mountains.MOUNTAIN_BORDER_INNER_SE)
  }
  if (neighbours.SW === 0 && neighbours.W !== 0 && neighbours.S !== 0) {
    borders.push(mountains.MOUNTAIN_BORDER_INNER_SW)
  }
...
function getMountainBorder(neighbours) {
  ...
  if (
    ...
    return mountains.MOUNTAIN_FOOT_BORDER_INNER_NW
  }
  ...
  if (
    ...
    return mountains.MOUNTAIN_FOOT_BORDER_INNER_NE
  }

  if (neighbours.N === mountains.MOUNTAIN_TILE_ID) {
    return mountains.MOUNTAIN_FOOT_BORDER_NORTH
  }

  if (neighbours.S === mountains.MOUNTAIN_TILE_ID) {
    return mountains.MOUNTAIN_FOOT_BORDER_SOUTH
  }

  if (neighbours.W === mountains.MOUNTAIN_TILE_ID) {
    return mountains.MOUNTAIN_FOOT_BORDER_WEST
  }

  if (neighbours.NE === mountains.MOUNTAIN_TILE_ID) {
    return mountains.MOUNTAIN_FOOT_BORDER_NE
  }

  if (neighbours.NW === mountains.MOUNTAIN_TILE_ID) {
    return mountains.MOUNTAIN_FOOT_BORDER_NW
  }

  if (neighbours.SW === mountains.MOUNTAIN_TILE_ID) {
    return mountains.MOUNTAIN_FOOT_BORDER_SW
  }
...
function getMountainWall(neighbours) {
  ...
  if (
    ...
    return mountains.MOUNTAIN_WALL_OUTER_XY
  }
  if (neighbours.E !== mountains.MOUNTAIN_TILE_ID) {
    return mountains.MOUNTAIN_WALL_OUTER_Y
  }
  if (neighbours.S !== mountains.MOUNTAIN_TILE_ID) {
    return mountains.MOUNTAIN_WALL_OUTER_X
  }

...
function getMountainBorders(neighbours) {
  ...
  if (
    ...
    borders.push(mountains[mountainType + "_FOOT_BORDER_INNER_NW"])
  }
  ...
  if (
    ...
    borders.push(mountains[mountainType + "_FOOT_BORDER_INNER_NE"])
  }

  if (neighbours.N === mountains[mountainType + "_TILE_ID"]) {
    borders.push(mountains[mountainType + "_FOOT_BORDER_NORTH"])
  }

  if (neighbours.S === mountains[mountainType + "_TILE_ID"]) {
    borders.push(mountains[mountainType + "_FOOT_BORDER_SOUTH"])
  }

  if (neighbours.W === mountains[mountainType + "_TILE_ID"]) {
    borders.push(mountains[mountainType + "_FOOT_BORDER_WEST"])
  }

  if (neighbours.NE === mountains[mountainType + "_TILE_ID"]) {
    borders.push(mountains[mountainType + "_FOOT_BORDER_NE"])
  }

  if (neighbours.NW === mountains[mountainType + "_TILE_ID"]) {
    borders.push(mountains[mountainType + "_FOOT_BORDER_NW"])
  }

  if (neighbours.SW === mountains[mountainType + "_TILE_ID"]) {
    borders.push(mountains[mountainType + "_FOOT_BORDER_SW"])
  }
...
module.exports.getMountainBorders = getMountainBorders
